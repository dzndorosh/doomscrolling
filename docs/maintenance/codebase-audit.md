...
| `tools/catalog-review/{review.html,review.js,review.css}` | Maintainer-only static review tool served locally, not loaded by Electron | **KEEP** outside Pages payload. |

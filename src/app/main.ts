...
/** Whichever player the settings currently point at. */
...
ipcMain.on('feed:close', () => youtube.hide());
ipcMain.handle('feed:next', () => catalogProvider.next());
ipcMain.handle('feed:previous', () => catalogProvider.previous());
...
ipcMain.on('feed:muted', (_event, value: unknown) => {

...
contextBridge.exposeInMainWorld('feed', {
  next: () => ipcRenderer.invoke('feed:next'),
  peek: () => ipcRenderer.invoke('feed:peek'),
  previous: () => ipcRenderer.invoke('feed:previous'),
  refresh: () => ipcRenderer.invoke('feed:refresh'),
  status: () => ipcRenderer.invoke('feed:status'),
  close: () => ipcRenderer.send('feed:close'),
  setMuted: (muted: boolean) => ipcRenderer.send('feed:muted', Boolean(muted)),
  reportFeedback: (feedback: unknown) => ipcRenderer.send('feed:feedback', feedback),
  reportPlaybackError: (value: unknown) => ipcRenderer.send('feed:playback-error', value),
